        ...
        <div className="mx-auto w-full max-w-5xl space-y-8 px-4 pb-12 md:px-8">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
                <TabsList className="grid h-auto min-h-9 w-full grid-cols-2 grid-rows-auto gap-1.5 rounded-xl bg-muted/60 p-1.5 text-muted-foreground sm:grid-cols-3 md:inline-flex md:flex-row md:flex-nowrap md:gap-0.5">
                    ...
                    <TabsTrigger
                        value="tags"
                        className="shrink-0 gap-2 rounded-lg px-3 py-2.5 text-sm transition-colors data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm md:min-w-[130px] md:px-4"
                    >
                    ...
                    <TabsTrigger
                        ...
                        className="shrink-0 gap-2 rounded-lg px-3 py-2.5 text-sm transition-colors data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm md:min-w-[170px] md:px-4"
                    >
